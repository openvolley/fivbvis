...
v_schema <- function(type) {
    switch(type,
           ...
           "Press Release Source Category" = tribble(~from, ~to, ~description,
                                                     0L, "None", "No source",
                                                     1L, "F\ueevb", "FIVB",
           ...
           "Press Release Special Type" = tribble(~from, ~to, ~description,
           ...
           ## https://www.fivb.org/VisSDK/VisWebService/PressReleaseCategory.html
           "Press Release Category" = tribble(~from, ~to, ~description,
                                              0L, "None", "No category",
           ...
           "Event Type" = tribble(~from, ~to, ~description,
           ...
           "Player Beach Team Status" = tribble(~from, ~to, ~description,
           ...
           "Beach Round Phase" = tribble(~from, ~to, ~description,
           ...
           "Beach Match Status" = tribble(~from, ~to, ~description,
           ...
           ## https://www.fivb.org/VisSDK/VisWebService/BeachRoundPhase.html
           "Beach Match Round Phase" = tribble(~from, ~to, ~description,
                                               1L, "ConfederationQuota", "Confederation quota round",
                                               2L, "FederationQuota", "Federation quota round",
                                               3L, "Qualification", "Qualification round",
                                               4L, "MainDraw", "Main draw"),
           ## https://www.fivb.org/VisSDK/VisWebService/BeachMatchResultType.html
           "Beach Match Result Type" = tribble(~from, ~to, ~description,
           ...
           "Beach Match Acquisition Method" = tribble(~from, ~to, ~description,
           ...
           "Beach Olympic Team Status" = tribble(~from, ~to, ~description,
           ...
           "Beach Tournament Status" = tribble(~from, ~to, ~description,
           ...
           "Organizer Type" = tribble(~from, ~to, ~description,
           ...
           "Event Gender" = tribble(~from, ~to, ~description,
                                    0L, "M", "Men",
                                    1L, "W", "Women",
                                    2L, "MW", "Men and women",
                                    3L, "Mixed", "Mixed teams"),
           ## https://www.fivb.org/VisSDK/VisWebService/BeachTournamentDispatchStatus.html
           "Beach Tournament Dispatch Status" = tribble(~from, ~to, ~description,
           ...
           "Beach Match Format" = tribble(~from, ~to, ~description,
