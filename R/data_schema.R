...
v_schema <- function(type) {
    switch(type,
           ...
           "Beach Team Type" = tribble(~from, ~to, ~descrption,
                                       0L,	"Normal",	"Normal",
           ...
           "Beach Round Phase" = tribble(~from, ~to, ~descrption,
           ...
           "Beach Match Status" = tribble(~from, ~to, ~descrption,
           ...
           ## https://www.fivb.org/VisSDK/VisWebService/BeachRoundPhase.html
           "Beach Match Round Phase" = tribble(~from, ~to, ~descrption,
                                               1L,	"ConfederationQuota",	"Confederation quota round",
                                               2L,	"FederationQuota",	"Federation quota round",
                                               3L,	"Qualification",	"Qualification round",
                                               4L,	"MainDraw",	"Main draw"),
           ## https://www.fivb.org/VisSDK/VisWebService/BeachMatchResultType.html
           "Beach Match Result Type" = tribble(~from, ~to, ~descrption,
           ...
           "Beach Match Acquisition Method" = tribble(~from, ~to, ~descrption,
           ...
           "Beach Olympic Team Status" = tribble(~from, ~to, ~descrption,
           ...
           "Beach Tournament Status" = tribble(~from, ~to, ~descrption,
           ...
           "Organizer Type" = tribble(~from, ~to, ~descrption,
           ...
           "Event Gender" = tribble(~from, ~to, ~descrption,
                                    0L, "M", "Men",
                                    1L, "W", "Women",
                                    2L, "MW", "Men and women",
                                    3L, "Mixed", "Mixed teams"),
           ## https://www.fivb.org/VisSDK/VisWebService/BeachTournamentDispatchStatus.html
           "Beach Tournament Dispatch Status" = tribble(~from, ~to, ~descrption,
           ...
           "Beach Match Format" = tribble(~from, ~to, ~descrption,
           ...
           "Beach Tournament Type" = tribble(~from, ~to, ~descrption,
