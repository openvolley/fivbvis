...
v_fields <- function(type) {
    switch(type,
           ...
           "Volleyball Player" = c("FirstName", "LastName", "Gender", "Block", "FederationCode", "ClubFederationCode", "ClubName", "DeletedDT", "Height", "IsCaptain", "IsLibero", "IsPreselected", "IsSelected", "LastChangeDT", "LastChangeUser", "LastChangeUsername", "NbSelOG", "NbSelOther", "NbSelWC", "No", "NoEvent", "NoPhoto", "NoPlayer", "NoShirt", "NoTeam", "NoTournament", "Spike", "Version", "Weight", "ActiveVolley", "ActiveBeach", "ActiveSnow"),
